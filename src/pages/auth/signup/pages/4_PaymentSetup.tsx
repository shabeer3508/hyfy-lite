            ...
            <CardContent className="">
                <form onSubmit={handleSubmit(handleCouponVerification)}>
                    <div className="grid w-full items-center gap-3">
                        ...
                        <div className="flex items-center dark:bg-[#23252A] rounded  border dark:border-[#FFFFFF1A] hover:dark:border-primary border-border ">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <Input
                            ...
                            className="outine-0 ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-xs border dark:border-[#FFFFFF1A] dark:bg-[#23252A]"
                        />
                        ...
                        <HYCombobox
                            ...
                            buttonClassName="w-full dark:border-[#FFFFFF1A] border-border dark:bg-[#23252A]"
                        />
                    </div>
                    <div className="mt-5">
