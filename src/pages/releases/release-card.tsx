...
const ReleaseCard: React.FC<ReleaseCardProps> = ({ data }) => {
  ...
  return (
    ...
    >
      <HYDialog className="max-w-7xl " content={<ReleaseDetail />}>
        <div className="flex gap-3 items-center h-16 px-4 cursor-auto">
      ...
      <div className="flex justify-between text-xs p-2 px-4">
        ...
        <div className="dark:text-[#737377]">
          Priority
          <span className="dark:text-white text-[#737377] capitalize ml-2">
            {data?.priority}
          </span>
        </div>
      </div>
